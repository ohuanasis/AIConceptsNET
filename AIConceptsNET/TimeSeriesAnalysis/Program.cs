...
namespace TimeSeriesAnalysis
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var filledDataView = mlContext.Transforms.ReplaceMissingValues(outputColumnName: nameof(TrafficData.Traffic), replacementMode: MissingValueReplacingEstimator.ReplacementMode.Mean)
